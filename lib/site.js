...
var getSiteConfiguration = function(token, tenant, code) {
	return new Promise(function(resolve, reject) {

	        request({
	            url : 'https://api.yaas.io/hybris/site/v1/' + tenant + '/sites/' + code,
	            method : 'GET',
...
var setConfiguration = function(token, tenant, key, value) {
	return new Promise(function(resolve, reject) {
	        ...
	        request({
	            url : 'https://api.yaas.io/hybris/configuration/v1/' + tenant + '/configurations',
	            method : 'POST',
	            headers : {'Authorization' : 'Bearer ' + token},
	            json:true,
	            body: {
...
var updateConfiguration = function(token, tenant, key, value) {
	return new Promise(function(resolve, reject) {
	        ...
	        request({
	            url : 'https://api.yaas.io/hybris/configuration/v1/' + tenant + '/configurations/' + key,
	            method : 'PUT',
	            headers : {'Authorization' : 'Bearer ' + token},
	            json:true,
	            body: {
...
module.exports = {
	...
	setSiteConfiguration : setSiteConfiguration,
	updateSiteConfiguration : updateSiteConfiguration,
	setOrUpdateSiteConfiguration : setOrUpdateSiteConfiguration*/
};
